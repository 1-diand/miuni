...
lib.ssMetadata = [
		{name:"miuni_atlas_1", frames: [[1683,622,211,147],[1730,465,211,155],[1470,532,211,155],[0,0,344,530],[346,0,344,530],[1730,0,142,463],[1896,622,142,57],[1943,428,94,182],[1874,0,94,426],[692,0,344,530],[1038,0,344,530],[345,679,1086,139],[345,532,1123,145],[1384,0,344,530],[0,532,343,528],[1433,689,243,114]]}
];
...
(lib.CachedBmp_103 = function() {
	this.initialize(ss["miuni_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_16 = new lib.CachedBmp_89();
...
// stage content:
(lib.miuni = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.inicio.setTransform(1280.25,942.3,0.7663,0.7663,0,0,0,105.7,77.7);
	new cjs.ButtonHelper(this.inicio, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get(this.inicio).to({_off:true},177).wait(233));

	// Capa_11
	this.instance = new lib.Interpolación24("synched",0);
	this.instance.setTransform(975.25,649.85);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:1053.25,y:662.15},185).to({startPosition:0},1).to({y:1665.45},58).wait(166));

	// _1684753_4810434_ai
	this.instance_1 = new lib.CachedBmp_87();
	this.instance_1.setTransform(638.65,456.35);

	this.instance_2 = new lib.Símbolo2();
	this.instance_2.setTransform(1319.15,731.6,1.0036,1.0036,0,0,0,74.5,295.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1}]}).to({state:[{t:this.instance_2}]},167).wait(243));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_92.png?1750271513504", id:"CachedBmp_92"},
		{src:"images/CachedBmp_91.png?1750271513504", id:"CachedBmp_91"},
		{src:"images/fondo.png?1750271513504", id:"fondo"},
		{src:"images/miuni_atlas_1.png?1750271513300", id:"miuni_atlas_1"},
		{src:"sounds/dnueve.mp3?1750271513504", id:"dnueve"},
		{src:"sounds/mouseclick290204.mp3?1750271513504", id:"mouseclick290204"},
		{src:"sounds/Proyectopredeterminado3.mp3?1750271513504", id:"Proyectopredeterminado3"}
	],
	preloads: []
};
